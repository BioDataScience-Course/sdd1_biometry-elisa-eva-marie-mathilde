...
Dans ce projet nous allons étudier le taux d'obésité dans le Hainaut à partir de données collectées dans cette région par différentes personnes. Les individus (hommes et femmes compris dans une classe d'âge entre 15 et 70 ans) on été soumis à différentes mesure de leurs corps et ont répondu à plusieurs questions concernant leur mode de vie. 
...
Pour effectuer les mensurations, nous avons utilisé plusieurs outils tels qu'un mètre ruban et une balance. Bien que ceux-ci ne fussent pas les mêmes tout au long de l'étude, ils ont été choisi avec soin. En effet, nous avons spécifiquement utilisé un mètre ruban car celui-ci n'évolue que faiblement dans le temps. De plus, nous avons calculé la masse selon la balance du laboratoire (masse_corr) afin que toute les masses soit comparable entre elles.  Nous pouvons donc considèrer nos valeurs fiables.
...
Ce graphique nous permet de confirmer que la majorité des individus font entre 60-80kg quelque soit leur profession.
...
$$H_0 : \overline{masse_{des femmes}}\ - \overline{masse_{des hommes}}\ =0 $$
$$H_1 : \overline{masse_{des femmes}}\ - \overline{masse_{des hommes}}\ \neq 0$$ 
...
En résumé, notre échantillon est principalement centré sur une population jeune ( entre 15 et 25 ans) et majoritairement masculine. Elle comporte un grand nombre de personnes pesant entre 60 et 80 kg. La taille n'influençant que très peu celle-ci. Les personnes les plus légère ont une activité proffesionnel intermédiaire en terme de mouvement. De plus, nos individus ont un mode de vie approximativement sain. Des différences ce rencontre selon le genre. Les hommes ont en moyenne une masse plus grande que les femmes. De surcroît, les femmes possèdent un tour de taille inférieur à celui des hommes.
