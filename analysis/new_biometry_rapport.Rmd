...
Nous rejetons H0 au seuil alpha = 5%. Il y a une différence significative entre les moyennes des masses. En effet, la moyenne de la masse des hommes est supérieure à la moyenne de la masse des femmes. (t.test = 6.6063, ddl = 264, p value = 4.6e-09).

### Test ANOVA

H0 : µtour_taille(homme) = µtour_taille(femme)
H1 : µtour_taille(homme) != µtour_taille(femme)
...
Nous pouvons rejeter H0 au seuil alpha = 5%. IL y a donc une différence significative entre les moyennes des tours de taille chez les hommes et les femmes. (ANOVA = 10.84, ddl = 1 & 251, p value = 0.001136).
